...
<div class="profile-header">
    ...
    <div class="profile-top">
        <img src="<?php echo htmlspecialchars($_SESSION['avatar'] ?? 'https://cdn-icons-png.flaticon.com/512/149/149071.png'); ?>" class="profile-avatar">
        <h2 class="profile-name"><?php echo htmlspecialchars($_SESSION['fullname'] ?? $_SESSION['user']); ?></h2>
    </div>
</div>
